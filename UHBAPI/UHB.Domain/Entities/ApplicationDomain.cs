...
public class ApplicationDomain : IBaseEntity
{
    ...
    public virtual StudentDomain? RegistrationNoNavigation { get; set; }
    public virtual RoomDomain? RoomNoNavigation { get; set; }
}
